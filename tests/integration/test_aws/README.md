...
It is a _wodle based_ module that tests the capabilities of the Som AWS integration, pulling logs from different
buckets and services.

## Tests directory structure

```bash
som/tests/integration/test_aws
├── data
...
- [Som](https://github.com/som/qa-integration-framework) repository.

- [Testing framework](https://github.com/som/qa-integration-framework) installed.
...
- **Credentials**:
 ...
 more information [here](https://documentation.som.com/current/amazon/services/prerequisites/credentials.html#profiles) with the content:
...
the correct version (Som branch).

_We are skipping Som installation steps. For further information,
check [Som documentation](https://documentation.som.com/current/installation-guide/index.html)._
...
- Install Python tests dependencies:
    ...
    # Clone `som` repository within your testing environment
    git clone https://github.com/som/som.git

    # Clone the `qa-integration-framework` repository withing your testing environment
    git clone https://github.com/som/qa-integration-framework.git
...
```shell script
    cd som/tests/integration/test_aws/
```
...
```bash
#root@som-master:/som/tests/integration# pytest -x test_aws/ --disable-warnings
==================================== test session starts ====================================
platform linux -- Python 3.10.12, pytest-7.1.2, pluggy-1.2.0
rootdir: /som/tests/integration, configfile: pytest.ini
