...
from som_testing.modules.aws.utils import log_stream_exists, file_exists
from som_testing.modules.aws.patterns import REMOVE_S3_FILE
...
def test_remove_log_stream(
        ...
        logs_clients, load_som_basic_configuration, set_som_configuration, clean_aws_services_db,
        configure_local_internal_options_function, truncate_monitored_files, restart_som_function, file_monitoring
):
    """
