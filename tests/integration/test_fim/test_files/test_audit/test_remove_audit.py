...
brief: These tests will check if the 'som-syscheckd' and 'auditd' daemons work together properly.
...
from som_testing.modules.fim.patterns import WHODATA_NOT_STARTED
...
def test_remove_audit(test_configuration, test_metadata, set_som_configuration, configure_local_internal_options,
    ...
    test_phases:
        - setup:
            ...
            - Remove auditd
            - Truncate som logs.
            - Restart som to apply configuration changes.
        - test:
    ...
    input_description: A test case is contained in external YAML file (configuration_remove_audit.yaml)
                       which includes configuration settings for the 'som-syscheckd' daemon
