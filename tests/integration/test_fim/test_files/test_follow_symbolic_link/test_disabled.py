...
from som_testing.modules.fim.patterns import EVENT_TYPE_ADDED, EVENT_TYPE_DELETED, LINKS_SCAN_FINALIZED
...
def test_disabled(test_configuration, test_metadata, set_som_configuration, truncate_monitored_files,
