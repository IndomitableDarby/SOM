...
from som_testing.constants.platforms import WINDOWS, MACOS
...
from som_testing.modules.fim.utils import get_fim_event_data
from som_testing.tools.monitors.file_monitor import FileMonitor
from som_testing.utils.file import truncate_file, write_file_write
...
def test_large_changes(test_configuration, test_metadata, configure_local_internal_options,
                        truncate_monitored_files, set_som_configuration, folder_to_monitor, daemons_handler, detect_end_scan):
    '''
    description: Check if the 'som-syscheckd' daemon detects the character limit in the file changes is reached
