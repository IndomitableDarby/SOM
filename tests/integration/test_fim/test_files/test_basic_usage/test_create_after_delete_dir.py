...
from som_testing.modules.fim.patterns import EVENT_TYPE_ADDED, EVENT_TYPE_DELETED, MONITORING_PATH
...
def test_create_after_delete(test_configuration, test_metadata, configure_local_internal_options,
                             truncate_monitored_files, set_som_configuration, folder_to_monitor, file_to_monitor, daemons_handler):
    '''
    ...
    som_log_monitor.start(generate_callback(MONITORING_PATH), timeout=60)
