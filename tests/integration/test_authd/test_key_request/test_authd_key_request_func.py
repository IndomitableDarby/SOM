...
brief: These tests will check if the 'som-authd' daemon correctly handles the key requests
...
references:
    ...
    - https://documentation.som.com/current/user-manual/registering/key-request.html
...
from som_testing.constants.paths.sockets import MODULESD_KREQUEST_SOCKET_PATH
...
def test_key_request_func(test_configuration, test_metadata, set_som_configuration, connect_to_sockets,
