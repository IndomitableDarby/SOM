...
brief: These tests will check if the 'som-authd' daemon correctly handles the enrollment requests,
       ...
       The 'som-authd' daemon can automatically add a Som agent to a Som manager and provide
...
def test_ossec_auth_messages(test_configuration, test_metadata, set_som_configuration,
    ...
    '''
    description:
        Checks if when the `som-authd` daemon receives different types of enrollment requests,
