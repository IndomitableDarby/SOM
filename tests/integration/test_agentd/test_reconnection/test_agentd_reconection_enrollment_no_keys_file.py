...
def test_agentd_reconection_enrollment_no_keys_file(test_metadata, set_som_configuration, configure_local_internal_options, truncate_monitored_files, remove_keys_file, daemons_handler):
    '''
    description: Check how the agent behaves when losing communication with
                 the 'som-remoted' daemon and a new enrollment is sent to
                 the 'som-authd' daemon.
