...
from som_testing.modules.analysisd.testrule import patterns
...
def test_invalid_signature_id(test_configuration, test_metadata, set_som_configuration, truncate_monitored_files,
    ...
    assertions:
        - Check that som starts
        - Check ".*som-testrule.*Empty 'if_sid' value. Rule '(\\d*)' will be ignored.*"
    ...
    '''
    # Start monitor
    monitor_invalid = file_monitor.FileMonitor(SOM_LOG_PATH)
