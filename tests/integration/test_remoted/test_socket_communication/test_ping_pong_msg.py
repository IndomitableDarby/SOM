...
from som_testing.tools.simulators.agent_simulator import send_ping_pong_messages
...
def test_ping_pong_message(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_som_configuration, restart_som_expect_error, protocols_list_to_str_upper_case):

    '''
    description: Check if 'som-remoted' sends the #pong message
