...
def test_connection_valid(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_som_configuration, restart_som_expect_error, protocols_list_to_str_upper_case, get_real_configuration):

    '''
    description: Check if 'som-remoted' sets 'connection' as 'secure' or 'syslog' properly.
