...
from som_testing.utils.network import format_ipv6_long, TCP, UDP
from som_testing.utils.sockets import send_message_to_syslog_socket
from som_testing.modules.api import utils
...
def test_denied_ips_syslog(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_som_configuration, restart_som_expect_error, get_real_configuration):

    '''
    description: Check that 'som-remoted' denied connection to the specified 'denied-ips'.
