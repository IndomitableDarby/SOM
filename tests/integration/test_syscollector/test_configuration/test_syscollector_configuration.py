...
brief: Som gathers information about the agent system (OS, hardware, packages, etc.) periodically in a DB and sends
...
references:
    - https://documentation.som.com/current/user-manual/capabilities/syscollector.html
    - https://documentation.som.com/current/user-manual/reference/ossec-conf/wodle-syscollector.html
'''
import sys
...
from som_testing.utils import services
...
from som_testing.modules.modulesd.syscollector import patterns
...
def test_syscollector_deactivation(test_configuration, test_metadata, set_som_configuration,
    ...
    parameters:
        ...
        - set_som_configuration:
            type: fixture
            brief: Set som configuration using the configuration template.
        ...
        - daemons_handler:
            type: fixture
            brief: Handler of Som daemons for each test case.
...
def test_syscollector_all_scans_disabled(test_configuration, test_metadata, set_som_configuration,
                                         configure_local_internal_options, truncate_monitored_files,
                                         daemons_handler):
    '''
...
def test_syscollector_invalid_configurations(test_configuration, test_metadata, set_som_configuration,
                                             configure_local_internal_options, truncate_monitored_files,
                                             daemons_handler):
    '''
...
def test_syscollector_default_values(test_configuration, test_metadata, set_som_configuration,
                                     configure_local_internal_options, truncate_monitored_files,
                                     daemons_handler):
    '''
...
def test_syscollector_scanning(test_configuration, test_metadata, set_som_configuration,
                               configure_local_internal_options, truncate_monitored_files,
                               daemons_handler):
    '''
