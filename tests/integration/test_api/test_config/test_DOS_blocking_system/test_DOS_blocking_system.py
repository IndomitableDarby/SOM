...
brief: These tests will check if the 'DOS' (Denial-of-service attack) blocking feature of the API handled
       by the 'som-apid' daemon is working properly. The Som API is an open source 'RESTful' API
...
from som_testing.constants.api import CONFIGURATION_TYPES, AGENTS_ROUTE
