...
brief: These tests will check if the IP blocking feature of the API handled by the 'som-apid' daemon
       is working properly. The Som API is an open source 'RESTful' API that allows for interaction
...
references:
    ...
    - https://documentation.som.com/current/user-manual/api/configuration.html#access
...
from som_testing.modules.api.patterns import API_LOGIN_ERROR_MSG
from som_testing.modules.api.utils import login
