...
config_path = Path(CONFIGURATIONS_PATH, 'som_basic_configuration_target.yaml')
...
def test_configuration_target(test_configuration, test_metadata, set_som_configuration, configure_local_internal_options, daemons_handler_module, stop_logcollector):
    '''
    description: Check if the 'som-logcollector' daemon detects invalid configurations for the 'target' attribute
                 ...
                 the Som API returns the same values for the 'localfile' section that the configured one.
