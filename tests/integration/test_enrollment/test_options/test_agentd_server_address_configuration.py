...
references:
    - https://documentation.som.com/current/user-manual/reference/ossec-conf/client.html#address
...
from som_testing.modules.agentd.patterns import ENROLLMENT_INVALID_SERVER, ENROLLMENT_RESOLVE_ERROR, ENROLLMENT_CONNECTED
...
from som_testing.utils.network import format_ipv6_long
...
def test_agentd_server_address_configuration(test_configuration, test_metadata, set_som_configuration, configure_local_internal_options,
