...
references:
    ...
    - https://documentation.som.com/current/user-manual/ruleset/testing.html?highlight=logtest
    - https://documentation.som.com/current/user-manual/capabilities/som-logtest/logtest-configuration.html
...
from som_testing.constants.daemons import ANALYSISD_DAEMON, SOM_DB_DAEMON
...
daemons_handler_configuration = {'daemons': [ANALYSISD_DAEMON, SOM_DB_DAEMON]}
...
def test_load_rules_decoders(test_metadata, daemons_handler_module, wait_for_logtest_startup,
    ...
    '''
    description: Check if 'som-logtest' does produce the right decoder/rule matching when processing a log under
    ...
    parameters:
        - daemons_handler_module:
            type: fixture
            brief: Som logtests daemons handler.
