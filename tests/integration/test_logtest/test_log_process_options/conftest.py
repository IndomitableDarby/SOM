...
from som_testing.constants import users
from som_testing.constants.paths.configurations import CUSTOM_RULES_FILE
...
def configure_rules_list(test_metadata):
    ...
    Restart Som is not needed for applying the configuration, is optional.
    """
    ...
    shutil.chown(CUSTOM_RULES_FILE, users.SOM_UNIX_USER, users.SOM_UNIX_GROUP)
