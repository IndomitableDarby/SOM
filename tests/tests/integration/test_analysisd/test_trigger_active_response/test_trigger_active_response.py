...
from som_testing.constants.paths.logs import ALERTS_JSON_PATH
...
def test_rules_triggers_ar(test_configuration, test_metadata, truncate_monitored_files, set_som_configuration,
    ...
    test_phases:
        - setup:
            - Copy custom rule and active response files to Som paths.
            - Create a new file which will be monitored with logcollector.
            - Set som configuration (add active_response command and localfile blocks).
        ...
        - teardown:
            ...
            - Restart initial som configuration.
