...
def test_enabled(test_configuration, test_metadata, load_som_basic_configuration, set_som_configuration,
...
def test_disabled(test_configuration, test_metadata, load_som_basic_configuration, set_som_configuration,
                 truncate_monitored_files, daemons_handler):
    """
    ...
    """
    # Start monitor
    monitor_disabled = file_monitor.FileMonitor(SOM_LOG_PATH)
