...
from som_testing.utils import callbacks, configuration, file
...
def test_dropping_events(test_configuration, test_metadata, load_som_basic_configuration, set_som_configuration,
