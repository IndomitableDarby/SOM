...
monitored_sockets_params = [(SOM_DB_DAEMON, mitm_wdb, True), (ANALYSISD_DAEMON, None, None)]
...
def test_validate_rare_socket_responses(
    ...
    '''
    description: Validate each response from the 'som-analysisd' daemon socket
                 to the 'som-db' daemon socket using rare 'syscheck' events
