...
def test_shuffle_no_option_tag(test_configuration, test_metadata, set_som_configuration, truncate_monitored_files,
...
def test_shuffle_options(test_configuration, test_metadata, set_som_configuration, truncate_monitored_files,
                         configure_local_internal_options, daemons_handler, wait_for_integratord_start):
    '''
