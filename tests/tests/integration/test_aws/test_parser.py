...
def test_bucket_and_service_missing(
        test_configuration, metadata, load_som_basic_configuration, set_som_configuration,
        configure_local_internal_options_function, truncate_monitored_files, restart_som_function_without_exception,
        file_monitoring
):
    """
    ...
    parameters:
        ...
        - restart_som_function_without_exception:
            type: fixture
            brief: Restart the som service catching the exception.
        - file_monitoring:
            type: fixture
