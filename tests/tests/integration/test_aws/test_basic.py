...
def test_bucket_defaults(
        test_configuration, metadata, create_test_bucket, load_som_basic_configuration, set_som_configuration,
        clean_s3_cloudtrail_db, configure_local_internal_options_function, truncate_monitored_files,
        restart_som_function, file_monitoring
):
    """
...
def test_service_defaults(
        test_configuration, metadata, create_test_log_group, load_som_basic_configuration,
