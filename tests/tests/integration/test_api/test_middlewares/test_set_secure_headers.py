...
brief: These tests will check if the set_secure_headers middleware of the API handled by the 'som-apid' daemon is
       working properly. The Som API is an open source 'RESTful' API that allows for interaction with the Som
...
from som_testing.constants.api import AGENTS_ROUTE, CONFIGURATION_TYPES
