...
def test_upload_configuration(test_configuration, test_metadata, backup_som_configuration, add_configuration,
    ...
    parameters:
        ...
        - backup_som_configuration:
            type: fixture
            brief: Save the initial som configuration and restore it after the test.
        - add_configuration:
            type: fixture
