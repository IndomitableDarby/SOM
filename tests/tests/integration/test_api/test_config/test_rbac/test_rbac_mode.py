...
brief: These tests will check if the 'rbac_mode' (Role-Based Access Control) setting of the API
       ...
       'whitelist mode' and 'blacklist mode'. The Som API is an open source 'RESTful' API
       that allows for interaction with the Som manager from a web browser, command line tool
...
references:
    ...
    - https://documentation.som.com/current/user-manual/api/configuration.html#rbac-mode
...
from som_testing.constants.api import CONFIGURATION_TYPES, MANAGER_INFORMATION_ROUTE
