...
from . import SOM_PYTHON_INTERPRETER_PATH, MOCK_SERVER_PATH, MOCK_SERVER_IMAGE, MOCK_SERVER_CONTAINER
...
def disable_ssl_verification():
    """Modify som/core/utils.py to avoid SSL certificate verification."""
    file_path = Path(SOM_PYTHON_INTERPRETER_PATH, '/som/core/utils.py')
