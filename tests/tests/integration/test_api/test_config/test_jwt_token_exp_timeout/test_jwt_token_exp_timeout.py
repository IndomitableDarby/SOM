...
brief: These tests will check if the 'auth_token_exp_timeout' setting of the API is working properly.
       ...
       The Som API is an open source 'RESTful' API that allows for interaction with the Som manager
...
references:
    ...
    - https://documentation.som.com/current/user-manual/api/configuration.html#auth-token-exp-timeout
