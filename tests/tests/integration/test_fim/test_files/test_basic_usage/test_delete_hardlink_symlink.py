...
from som_testing.modules.fim.patterns import INODE_ENTRIES_PATH_COUNT
...
def test_delete_hardlink_symlink(test_configuration, test_metadata, set_som_configuration, truncate_monitored_files,
