...
from som_testing.modules.fim.patterns import (IGNORING_DUE_TO_INVALID_NAME,
...
def test_valid_utf8_filenames_do_not_trigger_warning(test_configuration, test_metadata, set_som_configuration, configure_local_internal_options,
                                                     truncate_monitored_files, folder_to_monitor, daemons_handler, start_monitoring) -> None:
    '''
    description: Check if the 'som-syscheckd' correctly processes valid UTF-8 file names without triggering warnings.
    '''
