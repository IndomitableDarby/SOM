...
brief: File Integrity Monitoring (FIM) system watches selected files and triggering alerts when
       ...
       the 'som-syscheckd' daemon set in the 'process_priority' tag is applied successfully.
...
references:
    ...
    - https://documentation.som.com/current/user-manual/reference/ossec-conf/syscheck.html#process-priority
...
from som_testing.modules.agentd.configuration import AGENTD_DEBUG
from som_testing.constants.platforms import MACOS
from som_testing.utils.services import search_process_by_command
from som_testing.constants.daemons import SYSCHECK_DAEMON
...
def test_process_priority(test_configuration, test_metadata, configure_local_internal_options,
    ...
    '''
    description: Check if the process priority of the 'som-syscheckd' daemon set in the 'process_priority' tag
                 ...
                 the 'som-syscheckd' process. Finally, the test will compare the current process priority
    ...
    assertions:
        - Verify that the 'som-syscheckd' daemon is running.
        - Verify that the process priority of the 'som-syscheckd' daemon matches the 'process_priority' tag.

    input_description: A test case (ossec_conf) is contained in external YAML file (cases_process_priority.yaml)
                       which includes configuration settings for the 'som-syscheckd' daemon and,
