...
references:
    - https://documentation.som.com/current/user-manual/registering/restful-api-registration.html
...
from som_testing.utils.client_keys import get_client_keys
...
def test_agentd_server_configuration(test_metadata, truncate_monitored_files_module,
    ...
    '''
    description:
        Checks `som-api` responds correctly to agent registration requests. Also, ensure client.keys is update
