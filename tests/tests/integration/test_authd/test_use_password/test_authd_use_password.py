...
def read_random_pass():
    """
    Search for the random password creation in Som logs
    """
    passw = None
    try:
        with open(SOM_LOG_PATH, 'r') as log_file:
...
def test_authd_use_password(test_configuration, test_metadata, set_som_configuration,
