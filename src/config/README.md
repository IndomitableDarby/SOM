...
Som manager and agent configuration are managed and disposed to each module or system component in different ways.
...
* [Configuration documentation](https://documentation.som.com/current/user-manual/reference/ossec-conf/index.html)