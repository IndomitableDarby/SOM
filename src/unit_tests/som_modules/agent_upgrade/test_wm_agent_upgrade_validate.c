...
#include "../../wrappers/som/shared/debug_op_wrappers.h"
#include "../../wrappers/som/shared/mq_op_wrappers.h"
#include "../../wrappers/som/shared/url_wrappers.h"
#include "../../wrappers/som/os_crypto/sha1_op_wrappers.h"
#include "../../wrappers/som/wazuh_db/wdb_wrappers.h"
#include "../../wrappers/som/wazuh_modules/wm_agent_upgrade_wrappers.h"
...
void test_wm_agent_upgrade_validate_wpk_version_windows_https_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/windows/versions");
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/windows/");
...
void test_wm_agent_upgrade_validate_wpk_version_windows_http_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.som.com/wpk/windows/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "http://packages.som.com/wpk/windows/");
...
void test_wm_agent_upgrade_validate_wpk_version_windows_invalid_version(void **state)
{
    wm_agent_info *agent = state[0];
    wm_upgrade_task *task = state[1];
    char *repo = "packages.som.com/4.x/wpk";
    char *versions = NULL;
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.som.com/4.x/wpk/windows/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_windows_invalid_repo(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://error.som.com/wpk/windows/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_linux_https_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/linux/x64/");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_http_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.som.com/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "http://packages.som.com/wpk/linux/x64/");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_invalid_version(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.som.com/4.x/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_linux_invalid_repo(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://error.som.com/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_ubuntu_old_version(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/wpk/ubuntu/16.04/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/wpk/ubuntu/16.04/x64/");
...
void test_wm_agent_upgrade_validate_wpk_version_rhel_old_version(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/wpk/rhel/6/x86/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/wpk/rhel/6/x86/");
...
void test_wm_agent_upgrade_validate_wpk_version_macos_https_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/macos/x64/pkg/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/macos/x64/pkg/");
...
void test_wm_agent_upgrade_validate_wpk_version_macos_http_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.som.com/wpk/macos/x64/pkg/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "http://packages.som.com/wpk/macos/x64/pkg/");
...
void test_wm_agent_upgrade_validate_wpk_version_macos_x86_64(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/macos/pkg/intel64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/macos/pkg/intel64/");
...
void test_wm_agent_upgrade_validate_wpk_version_macos_aarch64(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/macos/pkg/arm64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/macos/pkg/arm64/");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_x86_64(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/linux/rpm/x86_64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/linux/rpm/x86_64/");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_aarch64(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/linux/rpm/aarch64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/linux/rpm/aarch64/");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_deb(void **state)
{
    ...
    expect_string(__wrap__mtwarn, tag, "som-modulesd:agent-upgrade");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_deb_force(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "som-modulesd:agent-upgrade");
    expect_string(__wrap__mtdebug1, formatted_msg, "(8170): Agent '0' with platform 'centos' will be upgraded using package 'deb'");

    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/linux/deb/amd64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/linux/deb/amd64/");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_deb_aarch64(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/linux/deb/arm64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/linux/deb/arm64/");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_unsupported_x86_64(void **state)
{
    ...
    assert_int_equal(ret, WM_UPGRADE_SYSTEM_NOT_SUPPORTED);
    assert_string_equal(task->wpk_repository, "packages.som.com/4.x/wpk/");
    assert_null(task->wpk_file);
    assert_null(task->wpk_sha1);
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_unsupported_rpm(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/linux/rpm/i386/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/linux/rpm/i386/");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_unsupported_deb(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.som.com/4.x/wpk/linux/deb/i386/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.som.com/4.x/wpk/linux/deb/i386/");
...
void test_wm_agent_upgrade_validate_wpk_exist(void **state)
{
    ...
    os_strdup("https://packages.som.com/4.x/wpk/windows/", task->wpk_repository);
...
void test_wm_agent_upgrade_validate_wpk_exist_diff_sha1(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "som-modulesd:agent-upgrade");
    expect_string(__wrap__mtdebug1, formatted_msg, "(8161): Downloading WPK file from: 'https://packages.som.com/4.x/wpk/windows/wazuh_agent_v4.0.0_windows.wpk'");

    expect_string(__wrap_wurl_request, url, "https://packages.som.com/4.x/wpk/windows/wazuh_agent_v4.0.0_windows.wpk");
...
void test_wm_agent_upgrade_validate_task_status_message_error_code(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "som-modulesd:agent-upgrade");
