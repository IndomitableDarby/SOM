...
#include "../../wrappers/som/wazuh_modules/wmodules_wrappers.h"
...
void test_wm_upgrade_agent_send_ack_message_error_exit(void **state)
{
    ...
    expect_string(__wrap__mterror_exit, tag, "som-modulesd:agent-upgrade");
...
void test_wm_agent_upgrade_start_agent_module_enabled(void **state)
{
    ...
    expect_string(__wrap__mtinfo, tag, "som-modulesd:agent-upgrade");
