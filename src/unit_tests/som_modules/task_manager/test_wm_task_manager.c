...
#include "../../wrappers/som/shared/cluster_op_wrappers.h"
#include "../../wrappers/som/shared/debug_op_wrappers.h"
#include "../../wrappers/som/shared/pthreads_op_wrappers.h"
#include "../../wrappers/som/os_net/os_net_wrappers.h"
#include "../../wrappers/som/som_modules/wm_task_manager_wrappers.h"

#include "../../som_modules/wmodules.h"
#include "../../som_modules/task_manager/wm_task_manager.h"
#include "../../som_modules/task_manager/wm_task_manager_tasks.h"
...
void test_wm_task_manager_destroy(void **state)
{
    ...
    expect_string(__wrap__mtinfo, tag, "som-modulesd:task-manager");
...
void test_wm_task_manager_init_bind_err(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "som-modulesd:task-manager");
...
void test_wm_task_manager_dispatch_ok(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "som-modulesd:task-manager");
