...
#include "../wrappers/som/os_crypto/sha256_op_wrappers.h"
#include "../wrappers/som/shared/hash_op_wrappers.h"
#include "../wrappers/som/shared/agent_op_wrappers.h"
#include "../wrappers/som/remoted/shared_download_wrappers.h"
#include "../wrappers/posix/dirent_wrappers.h"
#include "../wrappers/posix/unistd_wrappers.h"
#include "../wrappers/som/remoted/request_wrappers.h"
#include "../wrappers/som/remoted/remoted_op_wrappers.h"
#include "../wrappers/som/wazuh_db/wdb_global_helpers_wrappers.h"
#include "../wrappers/som/shared/hash_op_wrappers.h"
...
void test_lookfor_agent_group_with_group()
{
    ...
    char *msg = "Linux |localhost.localdomain |4.18.0-240.22.1.el8_3.x86_64 |#1 SMP Thu Apr 8 19:01:30 UTC 2021 |x86_64 [CentOS Linux|centos: 8.3] - Som v4.2.0 / ab73af41699f13fdd81903b5f23d8d00\nc2305e0ac17e7176e924294c69cc7a24 merged.mg\n#\"_agent_ip\":10.0.2.4";
    char *r_group = NULL;
...
void test_lookfor_agent_group_msg_without_enter()
{
    ...
    char *msg = "Linux |localhost.localdomain |4.18.0-240.22.1.el8_3.x86_64 |#1 SMP Thu Apr 8 19:01:30 UTC 2021 |x86_64 [CentOS Linux|centos: 8.3] - Som v4.2.0 / ab73af41699f13fdd81903b5f23d8d00c2305e0ac17e7176e924294c69cc7a24 merged.mg";
    char *r_group = NULL;
...
void test_validate_control_msg_shutdown_success(void** state)
{
    ...
    expect_string(__wrap_SendMSG, message, "1:som-remoted:ossec: Agent stopped: 'agent1->192.168.1.1'.");
...
void test_validate_control_msg_get_agent_version_fail(void** state)
{
    ...
    // but we need to queue it for som-db processing
    assert_int_equal(result, 1);
    assert_int_equal(is_startup, 1);
    assert_int_equal(is_shutdown, 0);
    assert_non_null(cleaned_msg);
