...
#include "../../../../som_modules/agent_upgrade/manager/wm_agent_upgrade_manager.h"
...
int __wrap_wm_agent_upgrade_validate_version(const char *som_version, const char *platform, wm_upgrade_command command, void *task);
