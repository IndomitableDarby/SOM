...
static int test_setup_file_timeout(void **state) {
    ...
    os_strdup("restart-som10", timeout_entry->command[0]);
    timeout_entry->command[1] = NULL;
    os_strdup("restart-som-10.0.0.1-root", timeout_entry->rkey);
...
static void test_ExecdStart_ok(void **state) {
    ...
    expect_string(__wrap_GetCommandbyName, name, "restart-som0");
    will_return(__wrap_GetCommandbyName, timeout);
    will_return(__wrap_GetCommandbyName, "restart-som");

    expect_string(__wrap__mdebug1, formatted_msg, "Executing command 'restart-som {"
                                                                                        "\"version\":\"1\","
                                                                                        "\"origin\":{"
                                                                                            "\"name\":\"node01\","
                                                                                            "\"module\":\"som-execd\""
...
static void test_ExecdStart_timeout_not_repeated(void **state) {
    ...
    expect_string(__wrap_GetCommandbyName, name, "restart-som10");
    will_return(__wrap_GetCommandbyName, timeout);
    will_return(__wrap_GetCommandbyName, "restart-som");
    ...
    expect_string(__wrap__mdebug1, formatted_msg, "Adding command 'restart-som {"
                                                                                    "\"version\":\"1\","
                                                                                    "\"origin\":{"
                                                                                        "\"name\":\"node01\","
                                                                                        "\"module\":\"som-execd\""
...
static void test_ExecdStart_fgets_err(void **state) {
    ...
    expect_string(__wrap__mdebug1, formatted_msg, "Active response won't be added to timeout list. Message not received with alert keys from script 'restart-som'");
...
static void test_ExecdStart_get_command_err(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "(1311): Invalid command name 'restart-som0' provided.");
