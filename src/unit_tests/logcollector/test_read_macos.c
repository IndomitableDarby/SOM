...
#include "../wrappers/som/shared/expression_wrappers.h"
#include "../wrappers/som/logcollector/logcollector_wrappers.h"
#include "../wrappers/som/logcollector/macos_log_wrappers.h"
