...
/* Som-logtest's fields names for the requests and responses */
...
/**
 * @brief Initialize Som Logtest. Initialize the listener and create threads
...
/**
 * @brief Main function of Som Logtest module
 *
