...
void w_inc_decoded_by_component_events(const char *component, const char *agent_id) {
    if (component != NULL) {
        if (!strcmp(component, "som-agent")) {
            w_inc_agent_decoded_events(agent_id);
        } else if (!strcmp(component, "som-agentlessd")) {
            w_inc_agentless_decoded_events(agent_id);
        } else if (!strcmp(component, "som-monitord")) {
            w_inc_monitor_decoded_events(agent_id);
        } else if (!strcmp(component, "som-remoted")) {
        ...
        } else if (!strcmp(component, "aws-s3") || !strcmp(component, "Som-AWS")) {
        ...
        } else if (!strcmp(component, "docker-listener") || !strcmp(component, "Som-Docker")) {
            w_inc_modules_docker_decoded_events(agent_id);
        } else if (!strcmp(component, "gcp-pubsub") || !strcmp(component, "gcp-bucket") || !strcmp(component, "Som-GCloud")) {
