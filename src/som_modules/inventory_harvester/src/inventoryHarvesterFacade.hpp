...
private:
    ...
    void initSomDBAgentEventSubscription();
    // void initSomDBFimEventSubscription(); // DISABLED: FIM events are no longer processed.
    void initSomDBInventoryEventSubscription();
