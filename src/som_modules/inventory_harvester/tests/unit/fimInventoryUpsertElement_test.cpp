/**
 * Som Inventory Harvester - FimInventoryUpsertElement Unit tests
...
TEST_F(FimInventoryUpsertElement, valid_Registry)
{
    ...
    EXPECT_EQ(
        ...
        R"({"id":"001_HASH_HASH","operation":"INSERTED","data":{"agent":{"id":"001","name":"agent-reg","host":{"ip":"agentIp"},"version":"agentVersion"},"registry":{"key":"Software\\App","hive":"HKLM","path":"HKLM\\Software\\App","gid":"gid","group":"groupName","uid":"uid","owner":"userName","architecture":"x86","mtime":"2025-04-09T15:45:00Z"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}},"event":{"category":"registry_key"}}})");
}
...
TEST_F(FimInventoryUpsertElement, valid_RegistryWithValue)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_HASH_HASH","operation":"INSERTED","data":{"agent":{"id":"001","name":"agent-reg","host":{"ip":"10.10.10.10"},"version":"v4.9.0"},"registry":{"key":"Software\\App","value":"InstallPath","hive":"HKLM","path":"HKLM\\Software\\App","data":{"hash":{"md5":"md5value","sha1":"sha1value","sha256":"sha256value"},"type":"REG_SZ"},"architecture":"[x32]"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}},"event":{"category":"registry_value"}}})");
}
