/**
 * Som Inventory Harvester - SystemInventoryUpsertElement Unit tests
...
TEST_F(SystemInventoryUpsertElement, validAgentID_Packages)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_packageItemId","operation":"INSERTED","data":{"package":{"architecture":"packageArchitecture","description":"packageDescription","installed":"packageInstallTime","name":"packageName","path":"packageLocation","size":0,"type":"packageFormat","version":"packageVersion","vendor":"packageVendor"},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_Processes)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_1234","operation":"INSERTED","data":{"process":{"args":["processName"],"args_count":1,"command_line":"processCmdline","name":"processName","pid":1234,"start":"processStartISO8601","parent":{"pid":1}},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_Ports)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_portItemId","operation":"INSERTED","data":{"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"destination":{"ip":"portRemoteIp","port":1234},"file":{"inode":"1111"},"host":{"network":{"egress":{"queue":7000},"ingress":{"queue":11000}}},"interface":{"state":"portState"},"network":{"transport":"portProtocol"},"process":{"name":"portProcess","pid":4321},"source":{"ip":"portLocalIp","port":7777},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_Hotfixes)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_KB12345","operation":"INSERTED","data":{"package":{"hotfix":{"name":"KB12345"}},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, emptyBoardId_Hw)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_unknown","operation":"INSERTED","data":{"host":{"cpu":{"cores":2,"name":"cpuName","speed":2497},"memory":{"free":50,"total":100,"used":50,"usage":0.5},"serial_number":"unknown"},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_Hw)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_boardInfo","operation":"INSERTED","data":{"host":{"cpu":{"cores":2,"name":"cpuName","speed":2497},"memory":{"free":50,"total":100,"used":50,"usage":0.5},"serial_number":"boardInfo"},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_NetworkProtocol)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netProtoItemId","operation":"INSERTED","data":{"network":{"dhcp":true,"gateway":"netProtoGateway","metric":150,"type":"netProtoType"},"interface":{"name":"netProtoIface"},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentIDEmptyGateway_NetworkProtocol)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netProtoItemId","operation":"INSERTED","data":{"network":{"dhcp":true,"metric":150,"type":"netProtoType"},"interface":{"name":"netProtoIface"},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_NetIface)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netIfaceItemId","operation":"INSERTED","data":{"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"host":{"mac":"netIfaceMac","network":{"ingress":{"bytes":1,"drops":2,"errors":3,"packets":4},"egress":{"bytes":5,"drops":6,"errors":7,"packets":8}}},"interface":{"alias":"netIfaceAdapter","mtu":9,"name":"netIfaceName","state":"netIfaceState","type":"netIfaceType"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_NetworkAddress)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netAddressItemId","operation":"INSERTED","data":{"network":{"broadcast":"192.168.0.255","ip":"192.168.0.1","netmask":"255.255.255.0","type":"IPv4"},"interface":{"name":"eth0"},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentIDEmptyBroadcast_NetworkAddress)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netAddressItemId","operation":"INSERTED","data":{"network":{"ip":"192.168.0.1","netmask":"255.255.255.0","type":"IPv4"},"interface":{"name":"eth0"},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentIDEmptyNetmask_NetworkAddress)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netAddressItemId","operation":"INSERTED","data":{"network":{"broadcast":"192.168.0.255","ip":"192.168.0.1","type":"IPv4"},"interface":{"name":"eth0"},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentIDEmptyAddress_NetworkAddress)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netAddressItemId","operation":"INSERTED","data":{"network":{"broadcast":"192.168.0.255","netmask":"255.255.255.0","type":"IPv4"},"interface":{"name":"eth0"},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validEmptyStrings_Groups)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_sudo","operation":"INSERTED","data":{"group":{"id":80,"name":"sudo","id_signed":-80,"is_hidden":false},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validEmptyStringsSingleUser_Groups)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_sudo","operation":"INSERTED","data":{"group":{"id":80,"name":"sudo","id_signed":-80,"is_hidden":false,"users":["user1"]},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validEmptyStringsMultipleUsers_Groups)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_sudo","operation":"INSERTED","data":{"group":{"id":80,"name":"sudo","id_signed":-80,"is_hidden":true,"users":["user1","user2","user3"]},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, negativeGroupID_Groups)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_sudo","operation":"INSERTED","data":{"group":{"name":"sudo","id_signed":-80,"is_hidden":true,"users":["user1","user2","user3"]},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validEmptyStrings_BrowserExtensions)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_fbdec581b7a6abd68fa838df2ec69f0e8f780eef","operation":"INSERTED","data":{"browser":{"profile":{"referenced":false}},"package":{"autoupdate":false,"enabled":false,"visible":false,"from_webstore":false,"name":"UBlock Origin","persistent":false},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validEmptyStrings_Services)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_itemId","operation":"INSERTED","data":{"process":{"pid":0},"service":{"exit_code":0,"frequency":0,"id":"apache2","inetd_compatibility":true,"starts":{"on_mount":false},"target":{"ephemeral_id":"0"},"win32_exit_code":0},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validNegativeValues_Services)
{
    ...
    EXPECT_CALL(*context, agentIp()).WillOnce(testing::Return("192.168.0.1"));
    EXPECT_CALL(*context, agentVersion()).WillOnce(testing::Return("agentVersion"));
    EXPECT_CALL(*context, serviceId()).WillOnce(testing::Return("som-agent"));
    EXPECT_CALL(*context, serviceName()).WillOnce(testing::Return("Som Agent"));
    ...
    EXPECT_CALL(*context, serviceProcessExecutable()).WillOnce(testing::Return("/usr/bin/som-agent"));
    ...
    EXPECT_CALL(*context, serviceAddress()).WillOnce(testing::Return("/lib/systemd/system/som-agent.service"));
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_itemId","operation":"INSERTED","data":{"file":{"path":"sourcePath"},"process":{"args":["arg1","arg2","arg3"],"executable":"/usr/bin/som-agent","group":{"name":"groupName"},"root_directory":"/root/","user":{"name":"root"},"working_directory":"/home/"},"service":{"address":"/lib/systemd/system/som-agent.service","description":"Monitors system activity","enabled":"enabled","following":"following","id":"som-agent","inetd_compatibility":true,"name":"Som Agent","object_path":"objectPath","restart":"restart","start_type":"startType","starts":{"on_mount":true,"on_not_empty_directory":["one","two","three"],"on_path_modified":["one","two","three"]},"state":"running","sub_state":"subState","target":{"address":"jobPath","type":"jobType"},"type":"type"},"log":{"file":{"path":"/var/log/"}},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validCompleteData_Services)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_itemId","operation":"INSERTED","data":{"file":{"path":"sourcePath"},"process":{"args":["arg1","arg2","arg3"],"executable":"/usr/bin/som-agent","group":{"name":"groupName"},"pid":1234,"root_directory":"/root/","user":{"name":"root"},"working_directory":"/home/"},"service":{"address":"/lib/systemd/system/som-agent.service","description":"Monitors system activity","enabled":"enabled","exit_code":1066,"following":"following","frequency":1000,"id":"som-agent","inetd_compatibility":true,"name":"Som Agent","object_path":"objectPath","restart":"restart","start_type":"startType","starts":{"on_mount":true,"on_not_empty_directory":["one","two","three"],"on_path_modified":["one","two","three"]},"state":"running","sub_state":"subState","target":{"address":"jobPath","ephemeral_id":"10","type":"jobType"},"type":"type","win32_exit_code":1066},"log":{"file":{"path":"/var/log/"}},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"som":{"cluster":{"name":"clusterName"},"schema":{"version":"1.0"}}}})");
}
