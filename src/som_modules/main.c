...
int main(int argc, char **argv)
{
    ...
    wmodule *cur_module;
    wm_debug_level = getDefine_Int("som_modules", "debug", 0, 2);
    ...
    int nofile = getDefine_Int("som_modules", "rlimit_nofile", 8192, 1048576);
...
void wm_help()
{
    print_out("Som Module Manager - %s\nSom Inc.", __ossec_version);
    print_out(" ");
...
void wm_handler(int signum)
{
    ...
    case SIGTERM:
        ...
        minfo("Shutting down Som modules.");
