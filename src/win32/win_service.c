...
static LPTSTR g_lpszServiceName        = "SomSvc";
static LPTSTR g_lpszServiceDisplayName = "Som";
static LPTSTR g_lpszServiceDescription = "Som Windows Agent";
    ...
    if (ossecServiceStatusHandle) {
        switch (dwOpcode) {
            case SERVICE_CONTROL_STOP:
                ...
                // Kill children processes spawned by modules, only in som-agent
                wm_kill_children();
                stop_wmodules();
