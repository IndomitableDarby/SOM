...
public:
    ...
    static void showHelp()
    {
        std::cout << "\nUsage: som-keystore <option(s)>\n"
                  ...
                  << "\nExample:"
                  << "\n\t./som-keystore -f indexer -k username -v admin\n"
                  << "\n\t./som-keystore -f indexer -k password -vp /path/to/file.txt\n"
                  << "\n\t./som-keystore -f indexer -k password < /path/to/file.txt\n"
                  << "\n\techo 'pass' | ./som-keystore -f indexer -k password\n"
                  << "\n\tcat /path/to/file.txt | ./som-keystore -f indexer -k password\n"
                  << std::endl;
    }
