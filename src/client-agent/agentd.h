...
/**
 * Function with all the necessary functionality to process the uninstallation validation of the Som agent package.
...
static const char AG_IN_UNMERGE[] = "som: Could not unmerge shared file.";
