...
/// Enumeration of communication with Som DB components.
typedef enum
{
    ...
    WB_COMP_SYSCOLLECTOR_BROWSER_EXTENSIONS,
    WB_COMP_SYSCOLLECTOR_SERVICES,
    WB_COMP_SYSCHECK,
    WB_COMP_FIM_FILE,
...
/// Enumeration of communication with Som DB status.
 ...
 *
 * @param[in] sock A Som DB socket connection.
