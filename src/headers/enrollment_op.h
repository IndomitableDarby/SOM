 ...
 *
 * Som agents need to register to a manager before being able to start sending messages
 ...
 * For details on enrollment process @see https://documentation.som.com/3.12/user-manual/registering/
 */
