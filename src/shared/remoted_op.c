                ...
                *str_tmp = '\0';
                ...
                if (str_tmp = strstr(line, " / "), str_tmp) {
                    *str_tmp = '\0';
                    ...
                    // If for some reason the separator between Som version and config sum is
                    // not found, we look for the Som version in the second part of the line.
