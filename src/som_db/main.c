...
int main(int argc, char ** argv)
{
    ...
    wconfig.worker_pool_size = getDefine_Int("som_db", "worker_pool_size", 1, 32);
    wconfig.commit_time_min = getDefine_Int("som_db", "commit_time_min", 1, 3600);
    wconfig.commit_time_max = getDefine_Int("som_db", "commit_time_max", 1, 3600);
    wconfig.open_db_limit = getDefine_Int("som_db", "open_db_limit", 1, 4096);
    nofile = getDefine_Int("som_db", "rlimit_nofile", 1024, 1048576);

    wconfig.fragmentation_threshold = getDefine_Int("som_db", "fragmentation_threshold", 0, 100);
    wconfig.fragmentation_delta = getDefine_Int("som_db", "fragmentation_delta", 0, 100);
    wconfig.free_pages_percentage = getDefine_Int("som_db", "free_pages_percentage", 0, 99);
    wconfig.max_fragmentation = getDefine_Int("som_db", "max_fragmentation", 0, 100);
    wconfig.check_fragmentation_interval = getDefine_Int("som_db", "check_fragmentation_interval", 1, 30758400);
    ...
    if (ReadConfig(modules, OSSECCONF, &gconfig, NULL) < 0) {
        merror_exit("Invalid configuration block for Som-DB.");
    }

    if (!isDebug()) {
        int debug_level;

        for (debug_level = getDefine_Int("som_db", "debug", 0, 2); debug_level; debug_level--) {
            nowDebug();
        }
    }

    mdebug1(SOM_HOMEDIR, home_path);
    ...
    router_register_api_endpoint("som-db","wdb-http.sock", "GET", "/v1/agents/ids", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("som-db","wdb-http.sock", "GET", "/v1/agents/ids/groups/:name", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("som-db","wdb-http.sock", "GET", "/v1/agents/ids/groups", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("som-db","wdb-http.sock", "GET", "/v1/agents/:agent_id/groups", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("som-db","wdb-http.sock", "POST", "/v1/agents/summary", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("som-db","wdb-http.sock", "GET", "/v1/agents/sync", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("som-db","wdb-http.sock", "POST", "/v1/agents/sync", (void*)&wdb_global_pre, (void*)&wdb_global_post);
    router_register_api_endpoint("som-db","wdb-http.sock", "POST", "/v1/agents/restartinfo", (void*)&wdb_global_pre, (void*)&wdb_global_post);
