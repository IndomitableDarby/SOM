...
typedef struct _somdb_breakdown_t {
    uint64_t remove_queries;
    struct timeval remove_time;
} somdb_breakdown_t;
...
typedef struct _queries_breakdown_t {
    ...
    somdb_breakdown_t somdb_breakdown;
} queries_breakdown_t;
...
/**
 * @brief Increment total somdb queries counter
 *
 */
void w_inc_somdb();

/**
 * @brief Increment remove somdb queries counter
 *
 */
void w_inc_somdb_remove();

/**
 * @brief Increment remove somdb time counter
 *
...
/**
 * @brief Increment syscollector web browser extensions information agent queries counter
 *
 */
...
/**
 * @brief Create a JSON object with all the som-db state information
 * @return JSON object
 */
