...
#define HOME_ERROR    "(1108): Unable to find Som install directory. Export it to SOM_HOME environment variable."
...
#define A_QUERY_ERROR           "(1286): Som-db query error, check wdb logs."
#define INVALID_TYPE            "(1287): Incorrect/unknown type value %s."
#define WDBC_QUERY_EX_ERROR     "(1288): Som-db query execution error."
...
#define AG_API_ERROR_CODE  "(4116): Unexpected status code in Som agent package uninstallation request: %ld\n"
#define AG_REQUEST_FAIL    "(4117): Failed validation request to uninstall Som agent package."
...
#define DB_COMPILED           "(5207): Som not compiled with support for '%s'."
...
#define LOGTEST_ERROR_INV_CONF                      "(7304): Invalid som-logtest configuration"
...
#define SOM_HOMEDIR "Som home directory: %s"
...
#define OS_NORMAL_BUFFER  "som: Agent buffer: 'normal'."
#define OS_WARN_BUFFER  "som: Agent buffer: '%d%%'."
#define OS_FULL_BUFFER  "som: Agent buffer: 'full'."
#define OS_FLOOD_BUFFER "som: Agent buffer: 'flooded'."
