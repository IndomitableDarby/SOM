...
# Som module: Github architecture
## Index
1. [Purpose](#purpose)
...
Som has the ability to obtain and process Github audit log through:
- Github module

## Sequence Diagram
Sequence diagram shows the basic flow of Som Github integration based on the configuration provided. Steps are:
