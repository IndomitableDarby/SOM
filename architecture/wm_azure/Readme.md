...
Som has the ability to obtain and read Microsoft Azure logs through:
- Azure Log Analytics
...
## Sequence diagram
Sequence diagram shows the basic flow of Som azure integration based on the configuration provided. Steps are:
