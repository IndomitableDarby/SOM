Automated Som Solaris packages using vagrant
==============================================

In this repository, you can find the necessary tools to build a Som package for Solaris 10 and 11 using vagrant.

## Tools needed to build the package

To build a Som package you need to install the following tools:
...
1. Download this repository, copy the `solaris10` or `solaris11` directory into `package_generation/src` and go to the `package_generation` directory:
    ```bash
    $ git clone https://github.com/som/som
    $ cp -r som/packages/solaris/solaris10 som/packages/solaris/package_generation/src
    $ cd som/packages/solaris/package_generation
    ```
...
2. Bring the machine up `vagrant [OPTION] ... up solaris10/solaris11`:
    ...
    ```
    * To build a som-agent package for Solaris 10 from branch v3.9.0 sources:
...
If you want to contribute to our project please don't hesitate to send a pull request. You can also join our users [mailing list](https://groups.google.com/d/forum/som) by sending an email to [som+subscribe@googlegroups.com](mailto:som+subscribe@googlegroups.com)or join our Slack channel by filling this [form](https://som.com/community/join-us-on-slack/) to ask questions and participate in discussions.

## License and copyright

SOM
Copyright (C) 2015 Som Inc.  (License GPLv2)
