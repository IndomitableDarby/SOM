...
def getWazuhInfo(wazuh_home):
    ...
    try:
        ...
        print("Seems like there is no Som installation.")
        return None
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='This script tests Som rules.')
    parser.add_argument('--path', '-p', default='/var/ossec', dest='wazuh_home',
                        help='Use -p or --path to specify Som installation path')
