...
As mentioned above, the Inventory Harvester module needs to connect to the Som Indexer through the Indexer Connector module.
...
It is important to verify the status of the Som Indexer **GET /_cluster/health**
