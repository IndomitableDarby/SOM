...
Docker-based unit testing suite for Som components with automated report generation.

## Overview

Runs Som's complete unit test suite using Docker, including CMocka tests, RTR toolset, and CTest integration for Linux/Windows components.

## Prerequisites

- Docker with permission to run containers
- Access to `ghcr.io/som/unit-tests:latest` image
...
- **Linux Manager CMocka tests**: Core Som manager functionality
