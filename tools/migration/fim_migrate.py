...
# Database support for Som HIDS.
# Copyright (C) 2015, Som Inc. <info@som.com>
# September 28, 2018.
...
def _print_help():
    print('''
    FIM database upgrade tool for Som
...
if __name__ == '__main__':
    ...
    if _verbose:
        logging.debug("Connected to SomDB socket ({0})".format(_wdb_socket))
