...
import exceptions
import tools
from integration import SomGCloudIntegration
...
try:
    ...
    raise exceptions.SomIntegrationException(errcode=1003, package=e.name)


class SomGCloudBucket(SomGCloudIntegration):
    ...
    def __init__(self, credentials_file: str, logger: logging.Logger, bucket_name: str, prefix: str = None,
        ...
        self.db_path = join(utils.find_som_path(), "wodles/gcloud/gcloud.db")
