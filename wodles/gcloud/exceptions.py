...
class WazuhIntegrationException(Exception):
    """Class that represents an exception for the Som external integrations.
...
class WazuhIntegrationInternalError(WazuhIntegrationException):
    """Class that represents a critical exception for the Som external integrations."""
    ERRORS = {
        # 1-99 -> Internal errors
        1: {
            'key': 'GCloudWazuhNotRunning',
            'message': 'Som must be running'
        },
        2: {
        ...
        3: {
            ...
            'message': 'Error sending event to Som'
        },
    }
