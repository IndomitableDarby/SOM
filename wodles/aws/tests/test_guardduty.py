...
def test_aws_guardduty_bucket_check_guardduty_type(mock_som_aws_integration, mock_sts,
...
@patch('som_integration.SomIntegration.get_sts_client')
@patch('som_integration.SomAWSDatabase.__init__')
def test_aws_guardduty_bucket_check_guardduty_type_handles_exceptions(mock_som_aws_integration, mock_sts):
...
@patch('som_integration.SomIntegration.get_sts_client')
@patch('som_integration.SomAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_full_prefix(mock_som_aws_integration, mock_sts, mock_service_prefix,
                                              guardduty_native):
...
@patch('som_integration.SomIntegration.get_sts_client')
@patch('som_integration.SomAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_base_prefix(mock_som_aws_integration, mock_sts, guardduty_native: bool):
...
@patch('som_integration.SomIntegration.get_sts_client')
@patch('som_integration.SomAWSDatabase.__init__')
def test_aws_guardduty_bucket_iter_regions_and_accounts(mock_som_aws_integration, mock_sts, guardduty_native: bool):
