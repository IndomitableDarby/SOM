...
def test_aws_inspector_send_describe_findings(mock_sts_client):
    ...
    with patch('som_integration.SomIntegration.send_msg') as mock_send_msg, \
...
@patch('som_integration.SomAWSDatabase.init_db')
@patch('som_integration.SomAWSDatabase.close_db')
