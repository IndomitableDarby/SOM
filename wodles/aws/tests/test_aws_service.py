...
def test_aws_service_initializes_properly(mock_som_integration, mock_version, mock_path, mock_client, mock_connect,
    ...
    mock_som_integration.assert_called_with(instance, service_name=utils.TEST_SERVICE_NAME,
...
@patch('som_integration.SomIntegration.__init__', side_effect=som_integration.SomIntegration.__init__)
def test_aws_service_get_last_log_date(mock_som_integration, mock_som_aws_database, mock_sts):
...
@patch('som_integration.SomAWSDatabase.__init__')
@patch('som_integration.SomIntegration.__init__', side_effect=som_integration.SomIntegration.__init__)
def test_aws_service_format_message(mock_som_integration, mock_som_aws_database, mock_sts):
