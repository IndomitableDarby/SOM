...
options_template = {'pretext': 'Som-X -- Alert generated', 'author_name': 'The amazing Som', 'footer': 'Slack API'}

msg_template = (
    '{"severity": 1, "pretext": "Som-X -- Alert generated", "title": "alert description", "text": "full log.", '
    ...
    '"full log.", "decoder": {"name": "decoder-name"}, "location": "som-X", "author_name": "The amazing Som",'
    '"footer": "Slack API"}'
)
slack_webhook = ''
