...
async def restore_default_passwords(script_args):
    ...
    from som.core.common import DEFAULT_RBAC_RESOURCES
    from som.security import update_user
...
async def reset_rbac_database(script_args):
    ...
    from som.core.security import rbac_db_factory_reset
...
def get_script_arguments():
    arg_parser = argparse.ArgumentParser(description="Som RBAC tool: manage resources from the Som RBAC database")
