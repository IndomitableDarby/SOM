...
with patch('som.common.som_uid'):
    with patch('som.common.som_gid'):
        ...
        from som.tests.util import get_fake_database_data, RBAC_bypasser, InitWDBSocketMock

        som.rbac.decorators.expose_resources = RBAC_bypasser
        from som import task, SomError
...
@patch('som.core.utils.SomDBConnection', return_value=InitWDBSocketMock(sql_schema_file='schema_tasks_test.sql'))
@patch.object(SomDBQueryTask, '_final_query', fake_final_query)
