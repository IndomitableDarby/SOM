...
from som.core.cluster import __version__
from som.core.common import AGENT_NAME_LEN_LIMIT, MAX_GROUPS_PER_MULTIGROUP, MAX_SOCKET_BUFFER_SIZE

GENERIC_ERROR_MSG = "Som Internal Error. See log for more detail"
DOCU_VERSION = 'current' if __version__ == '' else '.'.join(__version__.split('.')[:2]).lstrip('v')

class SomException(Exception):
    """
    Som Exception object.
    """

    ERRORS = {
        # < 999: API
        900: 'One of the API child processes terminated abruptly. The API process pool is not usable anymore. '
             'Please restart the Som API',
        ...
        1000: {'message': 'Som Internal Error',
               'remediation': 'Please, check `SOM_HOME/logs/ossec.log`, `SOM_HOME/logs/cluster.log` and '
                              '`SOM_HOME/logs/api.log` to get more information about the error'},
        ...
        1005: {'message': 'Error reading file',
               'remediation': 'Please, ensure you have the right file permissions in Som directories'},
        1006: {'message': 'File/directory does not exist or there is a problem with the permissions',
               'remediation': 'Please, check if path to file/directory is correct and `som` '
        ...
        1013: {'message': 'Unable to connect with socket',
               'remediation': 'Please, restart Som to restore sockets'},
        ...
        1016: {'message': 'Error moving file',
               'remediation': 'Please, ensure you have the required file permissions in Som directories'},
        1017: 'Some Som daemons are not ready yet in node "{node_name}" ({not_ready_daemons})',
        1018: 'Body request is not a valid JSON',
        1019: 'Error trying to create backup file',
        1020: {'message': 'Could not find any Som log file',
               'remediation': 'Please check `SOM_HOME/logs`'},

        # Configuration: 1100 - 1199
        1101: {'message': 'Requested component does not exist',
               'remediation': 'Run `SOM_PATH/bin/som-logtest -t` to check your configuration'},
        1102: {'message': 'Invalid section',
               'remediation': f'Please, visit the official documentation (https://documentation.som.com/'
        ...
        1106: {'message': 'Requested section not present in configuration',
               'remediation': 'Please, check your configuration file. '
                              f'You can visit the official documentation (https://documentation.som.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html) '
                              'to get more information about configuration sections'},
        ...
        1119: "Directory '/tmp' needs read, write & execution permission for 'som' user",
        ...
        1122: {'message': 'Experimental features are disabled',
               'remediation': 'Experimental features can be enabled in SOM_PATH/api/configuration/api.yaml'},
        1123: {
        ...
        1124: {'message': 'Remote command detected',
               'remediation': f'To solve this issue, please enable the remote commands in the API settings or add an '
                              f'exception: https://documentation.som.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1126: {'message': 'Error updating ossec configuration',
               'remediation': 'Please, ensure `SOM_PATH/etc/ossec.conf` has the proper permissions and ownership.'
               },
        1127: {'message': 'Protected section was modified',
               'remediation': 'To solve this, either revert the changes made to this section or disable the protection '
                              'in the API settings: '
                              f"https://documentation.som.com/{DOCU_VERSION}/user-manual/api/configuration.html"},
        ...
        1129: {'message': 'Higher version agents detected',
               'remediation': f'To solve this issue, please enable agents higher versions in the API settings: '
                              f'https://documentation.som.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1131: {'message': 'Virus Total API request error',
               'remediation': 'The use of Virus Total Public API keys is disabled but could not be checked. '
                              ...
                              f"https://documentation.som.com/{DOCU_VERSION}/user-manual/api/configuration.html"},
        # Rule: 1200 - 1299
        1200: {'message': 'Error reading rules from `SOM_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.som.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html)'
        ...
        1307: {'message': 'Invalid parameters',
               'remediation': 'Please, check that the update is correct, there is a problem while reading the results, '
                              'contact us at [official repository](https://github.com/som/som/issues)'
               },
        ...
        1707: {'message': 'Cannot send request, agent is not active',
               'remediation': 'Please, check non-active agents connection and try again. Visit '
                              f'https://documentation.som.com/{DOCU_VERSION}/user-manual/registering/index.html and '
                              f'https://documentation.som.com/{DOCU_VERSION}/user-manual/agents/agent-connection.'
        ...
        1726: {'message': 'Som authd is not running',
        ...
        1728: {'message': 'Invalid node type',
               'remediation': f'Valid types are `master` and `worker`. Please, visit https://documentation.som.com/'
        ...
        1730: {'message': 'Node does not exist',
               'remediation': 'Make sure the name is correct and that the node is up. You can check it using '
                              f'`cluster_control -l` (https://documentation.som.com/{DOCU_VERSION}/user-manual/'
        ...
        1734: {'message': 'Error removing agent from group',
               'remediation': f'Agent does not belong to specified group, to assign the agent to a group follow: '
                              f'https://documentation.som.com/{DOCU_VERSION}/user-manual/agents/grouping-agents.html'
               },
        ...
        1743: 'Error running Som syntax validator',
        ...
        1750: {'message': 'Could not send restart command, active-response is disabled in the agent',
               'remediation': "You can activate it in agents' `SOM_HOME/etc/ossec.conf`"},
        ...
        1914: {'message': 'Failed to reload ruleset',
               'remediation': 'Check the Som logs for details and verify the ruleset files and permissions.'},
        ...
        2003: {'message': 'Error in somdb request',
        ...
        2006: {'message': 'Received JSON from Som DB is not correctly formatted'},
        2007: {'message': 'Error retrieving data from Som DB'},
        2008: {'message': 'Corrupted RBAC database',
               'remediation': 'Restart the Som service to restore the RBAC database to default'},
        2009: {'message': 'Pagination error. Response from som-db was over the maximum socket buffer size'},
        2010: {'message': 'The requested read operation did not complete fully'},
        2011: {'message': 'Could not connect to the som-db unix socket'},
        2012: {'message': 'Invalid som-db HTTP request'},
        2013: {'message': 'Error sending HTTP request'},
        2014: {'message': 'The som-db client connection timeout has been exceeded'},
        2015: {'message': 'Invalid request URL scheme'},
        2016: {'message': 'Invalid unix socket path'},
        2017: {'message': 'Could not retrieve agents synchronization information from som-db'},
        ...
        3013: {'message': 'Cluster is not running, it might be disabled in `SOM_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.som.com/'
                              f'{DOCU_VERSION}/user-manual/configuring-cluster/index.html)'
                              ' to get more information about how to configure a cluster'
               },
        ...
        3019: 'Som is running in cluster mode: {EXECUTABLE_NAME} is not available in worker nodes. Please, '
        ...
        3023: {'message': 'Worker node is not connected to master',
               'remediation': 'Check the cluster.log located at SOM_HOME/logs/cluster.log file to see if there are '
                              'connection errors. Restart the `som-manager` service.'},
        3024: "Length of command exceeds limit defined in som.cluster.common.Handler.cmd_len.",
        3025: {'message': "Could not decrypt message",
               'remediation': "Check the cluster key is correct in the worker's "
                              f"[ossec.conf](https://documentation.som.com/{DOCU_VERSION}/user-manual/reference/"
        ...
        3028: {'message': "Worker node ID already exists",
               'remediation': f"Check and fix [worker names](https://documentation.som.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `som-manager` service."},
        3029: {"message": "Connected worker with same name as the master",
               "remediation": f"Check and fix the [worker name](https://documentation.som.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `som-manager` service in the node"},
        3030: {'message': 'Worker does not belong to the same cluster',
               'remediation': f"Change the [cluster name](https://documentation.som.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#name)"
                              " in the worker configuration to match the master's and restart the `som-manager` "
                              "service"},
        3031: {'message': "Worker and master versions are not the same",
               'remediation': f"[Update](https://documentation.som.com/{DOCU_VERSION}/upgrade-guide/index.html)"
        ...
        4000: {'message': "Permission denied",
               'remediation': "Please, make sure you have permissions to execute the current request. "
                              ...
                              f"som.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html"},
        ...
        4008: {'message': 'The specified resource is required for a correct Som\'s functionality'},
        ...
        4019: {'message': 'Invalid resource specified',
               'remediation': f'Please, check the current RBAC resources, for more information please visit https:/'
                              f'/documentation.som.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html'},
        ...
        5008: {'message': 'The current user cannot be deleted',
               'remediation': 'You can delete this user with the administrator user (som) or '
        ...
        6001: {'message': 'Maximum number of requests per minute reached',
               'remediation': f'This limit can be changed in api.yaml file. More information here: https:/'
                              f'/documentation.som.com/{DOCU_VERSION}/user-manual/api/configuration.html#'
        ...
        6003: {'message': 'Error trying to load the JWT secret',
               'remediation': 'Make sure you have the right permissions: SOM_PATH/api/configuration/security/'
                              'jwt_secret'},
        6004: {'message': 'The current user does not have authentication enabled through authorization context',
               'remediation': f'You can enable it using the following endpoint: https://documentation.som.com/'
                              f'{DOCU_VERSION}/user-manual/api/reference.html#operation/api.controllers.'
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
        ...
        dapi_errors : dict
            Dictionary with details about node and logfile. I.e.: {'master-node': {'error': 'Som Internal error',
            'logfile': SOM_HOME/logs/api.log}}
        title : str
    ...
    def __eq__(self, other):
        if not isinstance(other, SomException):
    ...
    def __or__(self, other):
        if isinstance(other, SomException):
...
class SomInternalError(SomException):
    """
...
class SomClusterError(SomInternalError):
    """
    This type of exception is raised inside the cluster.
    """
    _default_type = "about:blank"
    _default_title = "Som Cluster Error"


class SomHAPHelperError(SomClusterError):
    """
...
class SomError(SomException):
    ...
    def __or__(self, other):
        result: SomError = super().__or__(other)
        if isinstance(result, SomError):
...
class SomPermissionError(SomError):
    """
...
class SomResourceNotFound(SomError):
    """
...
class SomTooManyRequests(SomError):
    """
...
class SomNotAcceptable(SomError):
    """
