...
from som.core.cluster import client, cluster, server
from som.core.cluster import common as c_common
from som.core.cluster.dapi import dapi
from som.core.cluster.utils import context_tag
...
class LocalServer(server.AbstractServer):
    ...
    async def start(self):
        ...
        socket_path = os.path.join(common.SOM_PATH, 'queue', 'cluster', 'c-internal.sock')
