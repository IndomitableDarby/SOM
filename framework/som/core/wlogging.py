...
class TimeBasedFileRotatingHandler(logging.handlers.TimedRotatingFileHandler):
    """
    Som log rotation. It rotates the log at midnight and sets the appropriate permissions to the new log file.
    """
    ...
    def doRollover(self):
        ...
        # Save rotated file in {SOM_PATH}/logs/api directory
...
class SizeBasedFileRotatingHandler(logging.handlers.RotatingFileHandler):
    """Som log rotation. It rotates when the logging file size exceeds the maximum number of bytes configured."""
...
class SomLogger:
    """
    Define attributes of a Python Som daemon's logger.
    """
    def __init__(self, foreground_mode: bool, log_path: str, debug_level: [int, str], logger_name: str = 'som',
        ...
        log_path : str
            Filepath of the file to send logs to. Relative to the Som installation path.
        ...
        """
        self.log_path = os.path.join(common.SOM_PATH, log_path)
        self.logger = None
