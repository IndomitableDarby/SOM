...
API_MAIN_PROCESS = 'som-apid'
API_LOCAL_REQUEST_PROCESS = 'som-apid_exec'
API_SECURITY_EVENTS_PROCESS = 'som-apid_events'
API_AUTHENTICATION_PROCESS = 'som-apid_auth'
...
def create_pid(name: str, pid: int):
    ...
    Raises
    ------
    SomInternalError(3002)
        Error creating pidfile.
    """
    filename = path.join(common.SOM_PATH, common.OS_PIDFILE_PATH, f'{name}-{pid}.pid')
    ...
    with open(filename, 'a') as fp:
        try:
            ...
            raise SomInternalError(3002, str(e))
...
def delete_child_pids(name: str, ppid: int, logger: logging.Logger):
    ...
    logger : logging.Logger
        Logger object.
    """
    filenames = glob.glob(path.join(common.SOM_PATH, common.OS_PIDFILE_PATH, f'{name}*.pid'))
