...
from som.core.utils import SomDBQuery, SomDBBackend, get_fields_to_nest, plain_dict_to_nested_dict, \
    get_date_from_timestamp
from som.core.wdb import SomDBConnection


class SomDBQuerySyscheck(SomDBQuery):
    nested_fields = ['value']
    ...
    def __init__(self, agent_id, nested=False, default_sort_field='mtime', min_select_fields=None, *args,
        ...
        super().__init__(backend=SomDBBackend(agent_id), default_sort_field=default_sort_field,
...
def syscheck_delete_agent(agent: str, wdb_conn: SomDBConnection) -> None:
