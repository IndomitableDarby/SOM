...
from som.core.utils import SomDBQuery, SomDBBackend, get_utc_strptime
from som.core.utils import process_array

# Default request_slice value
DEFAULT_REQUEST_SLICE = 500

# Optimal request_slice values for each SomDBQuery
# TACTICS_REQUEST_SLICE = 500  # Default SomDBQueryMitre request_slice value
...
class SomDBQueryMitre(SomDBQuery):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 distinct: bool = False):
        """Create an instance of the SomDBQueryMitre class.
        ...
        request_slice : int
            Max limit used in the SomDBBacked backend object.
        distinct : bool
        ...
        SomDBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              backend=SomDBBackend(query_format='mitre', request_slice=request_slice),
                              distinct=distinct)
...
class SomDBQueryMitreMetadata(SomDBQueryMitre):
    """Class that handles the MITRE metadata."""

    TABLE_NAME = 'metadata'

    def __init__(self):
        """Create an instance of the SomDBQueryMitreMetadata class."""

        min_select_fields = {'key', 'value'}
        fields = {'key': 'key', 'value': 'value'}

        SomDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=min_select_fields, fields=fields,
...
class SomDBQueryMitreRelational(SomDBQueryMitre, ABC):
    """Abstract class used to overload the _format_data_into_dictionary method of SomDBQueryMitre.
...
class SomDBQueryMitreRelationalPhase(SomDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
        ...
        """Create an instance of the SomDBQueryMitreRelationalPhase class.
...
class SomDBQueryMitreRelationalMitigate(SomDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, dict_key: str = None, request_slice: int = DEFAULT_REQUEST_SLICE):
        """Create an instance of the SomDBQueryMitreRelationalMitigate class.
...
class SomDBQueryMitreRelationalUse(SomDBQueryMitreRelational):
...
class SomDBQueryMitreMitigations(SomDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
        ...
        """Create an instance of the SomDBQueryMitreMitigations class.
        ...
        SomDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=self.min_select_fields,
    ...
    def _execute_data_query(self):
        ...
        with SomDBQueryMitreRelationalMitigate() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with SomDBQueryMitreReferences(limit=None, filters={'type': 'mitigation'},
...
class SomDBQueryMitreReferences(SomDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None):
        """Create an instance of the SomDBQueryMitreReferences class.
...
class SomDBQueryMitreTactics(SomDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the SomDBQueryMitreTactics class.
    ...
    def _execute_data_query(self):
        ...
        with SomDBQueryMitreRelationalPhase() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with SomDBQueryMitreReferences(limit=None, filters={'type': 'tactic'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class SomDBQueryMitreTechniques(SomDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the SomDBQueryMitreTechniques class.
    ...
    def _execute_data_query(self):
        ...
        with SomDBQueryMitreRelationalPhase(dict_key='tech_id') as mitre_relational_query:
            tactics = mitre_relational_query.run()

        with SomDBQueryMitreRelationalMitigate(dict_key='target_id') as mitre_relational_query:
            mitigations = mitre_relational_query.run()

        with SomDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'software'},
                                            dict_key='target_id',
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()

        with SomDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'group'},
        ...
        with SomDBQueryMitreReferences(limit=None, filters={'type': 'technique'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class SomDBQueryMitreGroups(SomDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the SomDBQueryMitreGroups class.
        ...
        SomDBQueryMitre.__init__(self, table=f"`{self.TABLE_NAME}`", min_select_fields=self.min_select_fields,
                                   fields=self.fields, filters=filters, offset=offset, limit=limit, query=query,
                                   count=count, sort=sort, default_sort_field=default_sort_field,
                                   default_sort_order=default_sort_order, search=search,
                                   select=list(set(self.fields.values()).intersection(set(select))),
    ...
    def _execute_data_query(self):
        ...
        with SomDBQueryMitreRelationalUse(filters={'target_type': 'software', 'source_type': 'group'},
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()
        ...
        with SomDBQueryMitreReferences(limit=None, filters={'type': 'group'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class SomDBQueryMitreSoftware(SomDBQueryMitre):
    ...
    def _execute_data_query(self):
        ...
        with SomDBQueryMitreReferences(limit=None, filters={'type': 'software'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
def get_mitre_items(mitre_class: callable) -> tuple:
    ...
    mitre_class : callable
        SomDBQueryMitre class used to obtain certain MITRE resources.
