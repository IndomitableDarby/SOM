...
from som.core.results import AffectedItemsSomResult, merge
from som.core.syscollector import SomDBQuerySyscollector, get_valid_fields, Type
...
def get_item_agent(agent_list: list, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: dict = None,
                   ...
                   nested: bool = True, element_type: str = 'os', distinct: bool = False) -> AffectedItemsSomResult:
    ...
    for agent in agent_list:
        try:
            ...
            with SomDBQuerySyscollector(agent_id=agent, offset=offset, limit=limit, select=select,
                                          search=search,
        ...
        except SomResourceNotFound as e:
