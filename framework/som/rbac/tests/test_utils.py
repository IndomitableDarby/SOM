...
from som.core.utils import common
from som.rbac.utils import RESOURCES_CACHE, expand_decoders, expand_lists, expand_rules

test_data_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'data')
test_files_path = os.path.join(test_data_path, 'utils')


@patch('som.core.utils.common.RULES_PATH', new=test_files_path)
@patch('som.core.utils.common.USER_RULES_PATH', new=test_files_path)
...
@patch('som.core.utils.common.DECODERS_PATH', new=test_files_path)
@patch('som.core.utils.common.USER_DECODERS_PATH', new=test_files_path)
...
@patch('som.core.utils.common.LISTS_PATH', new=test_files_path)
@patch('som.core.utils.common.USER_LISTS_PATH', new=test_files_path)
