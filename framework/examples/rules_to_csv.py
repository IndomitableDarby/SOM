...
###
#  Copyright (C) 2025, Som Inc.All rights reserved.
#  Som.com
#
...
# Instructions:
#  - Use the embedded interpreter to run the script: {som_path}/framework/python/bin/python3 rules_to_csv.py
...
if __name__ == '__main__':
    ...
    for step in range(0, n_rules, 500):
        result = som.rule.get_rules(limit=500, offset=step).render()
        if not result:
            break
