...
from som.core import configuration
from som.core.cluster.dapi.dapi import DistributedAPI
from som.core.manager import query_update_check_service
...
async def get_status(pretty: bool = False, wait_for_complete: bool = False) -> ConnexionResponse:
    """Get manager's or local_node's som daemons status
...
async def get_daemon_stats(pretty: bool = False, wait_for_complete: bool = False, daemons_list: list = None):
    """Get Som statistical information from the specified manager's daemons.
...
async def get_stats(pretty: bool = False, wait_for_complete: bool = False, date: str = None) -> ConnexionResponse:
    ...
    Returns Som statistical information for the current or specified date.
...
async def get_stats_hourly(pretty: bool = False, wait_for_complete: bool = False) -> ConnexionResponse:
    ...
    Returns Som statistical information per hour. Each number in the averages field represents the average of alerts
    per hour.
...
async def get_stats_weekly(pretty: bool = False, wait_for_complete: bool = False) -> ConnexionResponse:
    ...
    Returns Som statistical information per week. Each number in the averages field represents the average of alerts
...
async def get_log(pretty: bool = False, wait_for_complete: bool = False, offset: int = 0, limit: int = None,
    ...
    """Get manager's or local_node's last 2000 som log entries.
...
async def get_log_summary(pretty: bool = False, wait_for_complete: bool = False) -> ConnexionResponse:
    """Get manager's or local_node's summary of the last 2000 som log entries.
...
async def get_conf_validation(pretty: bool = False, wait_for_complete: bool = False) -> ConnexionResponse:
    """Check if Som configuration is correct in manager or local_node.
