...
import som.ciscat as ciscat
import som.rootcheck as rootcheck
import som.syscheck as syscheck
import som.syscollector as syscollector
...
def check_experimental_feature_value(func):
    ...
    async def wrapper(*args, **kwargs):
        if not configuration.api_conf['experimental_features']:
            raise_if_exc(SomResourceNotFound(1122))
        else:
