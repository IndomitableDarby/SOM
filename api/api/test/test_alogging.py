...
REQUEST_HEADERS_TEST = {'authorization': 'Basic d2F6dWg6cGFzc3dvcmQxMjM='}  # som:password123
...
def test_somjsonformatter(message, dkt):
    """Check som json formatter is working as expected.
...
def test_custom_logging(path, hash_auth_context, body, loggerlevel):
    ...
    user, remote, method = ('som', '1.1.1.1', 'POST')
