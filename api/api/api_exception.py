...
from som.core.exception import DOCU_VERSION, SomTooManyRequests


class APIException(Exception):
    """
    Som API exception class.
    """
    ...
    def __init__(self, code: int, details: str = None):
        ...
        self.exceptions = {
            2000: 'Some parameters are not expected in the configuration file '
                  f"(SOM_PATH/{RELATIVE_CONFIG_FILE_PATH}). Please check the documentation for further details: "
            ...
            2001: 'Error creating or reading secrets file. Please, ensure '
                  ...
                  f'SOM_PATH/{RELATIVE_SECURITY_PATH}',
...
class MaxRequestsException(ProblemException):
    ...
    def __init__(self, code):
        exc = SomTooManyRequests(code=code)
        ext = {"code": exc.code}
