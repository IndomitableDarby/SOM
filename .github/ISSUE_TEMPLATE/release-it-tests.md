...
| **som/som tag**                   | https://github.com/som/som/tree/vSOM_VERSION-TAG    |
| **som/som-qa tag**                | https://github.com/som/som-qa/tree/vSOM_VERSION-TAG |
...
The objective of this issue is to check that the integration tests pass successfully against the version `SOM_VERSION` of Som.
