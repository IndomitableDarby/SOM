...
title: 'Release [SOM VERSION] - [STAGE] - System tests'
...
These requirements should be requested to the @som/devel-devops team via https://github.com/som/internal-devel-requests.

For further information, check https://github.com/som/som-qa/tree/main/tests/system/README.md
