...
def translate_uid(id):
    # If som_uid was not set, use the default behavior
    import pwd
    if som_uid == -1:
...
def translate_gid(id):
    # If som_gid was not set, use the default behavior
    import grp
    if som_gid == -1:
...
if __name__ == "__main__":
    ...
    print("Som File Integrity Check")
    ...
    arg_parser.add_argument("-wg", "--som_gid", type=int,
                            help="The group id for som", default=-1)
    arg_parser.add_argument("-wu", "--som_uid", type=int,
                            help="The user id for som", default=-1)
    ...
    som_gid = args.som_gid
    som_uid = args.som_uid
